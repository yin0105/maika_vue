              ...
              <div id="card_container_2">
                <div class="grid grid-cols-10 gap-x-8 gap-y-6 pt-2">
                    ...
                    <div class="col-span-4">
                      <label for="firstName" class="my-bootstrap">First Name</label>
                      <b-form-input v-model="firstName" :state="validation" id="firstName" class="my-bootstrap"></b-form-input>
                    ...
                    <div class="lg:col-start-7 lg:col-span-4">
                      <label for="lastName" class="my-bootstrap">Last Name</label>
                      <b-form-input v-model="lastName" :state="validation" id="lastName" class="my-bootstrap"></b-form-input>
                      <b-form-invalid-feedback :state="validation">
                        Your user ID must be 5-12 characters long.
                      </b-form-invalid-feedback>
                      <b-form-valid-feedback :state="validation">
                  ...
                  <div class="lg:col-span-6">
                    <label for="position" class="my-bootstrap">Position</label>
                    <b-form-input v-model="position" :state="validation" id="position" class="my-bootstrap"></b-form-input>
                    <b-form-invalid-feedback :state="validation">
                      Your user ID must be 5-12 characters long.
                    </b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validation">
                  ...
                  <!-- Email -->
                  <div class="lg:col-span-6">
                    <label for="email" class="my-bootstrap">Email</label>
                    <b-form-input v-model="email" type="email" :state="validation" id="email" class="my-bootstrap"></b-form-input>
                    <b-form-invalid-feedback :state="validation">
                      Your user ID must be 5-12 characters long.
                    </b-form-invalid-feedback>
                    <b-form-valid-feedback :state="validation">
                ...
                <div class="grid grid-cols-10 mt-24">
                  ...
                  <div class="col-span-5">
                    <b-button class="bottom-btn create flex items-center float-right">
